...
{
    public class BetweenElement : UIElement<Control>
    {
        /// <summary>
        ...
        private UIElement<Control> _element1, _element2;
        public BetweenElement(UIElement<Control> element1, UIElement<Control> element2)
        {
            _element1 = element1;
            _element2 = element2;
